...
* **New features**:
    ...
    6. `createEmptyGithubRepo`, `createEmptyRepo(type ='github')` and `cloneGithubRepo` now reacts on new `default` parameter which sets newly created/cloned repositories (GitHub and synchronized with it Local one) as default [https://github.com/pbiecek/archivist/issues/171 , https://github.com/pbiecek/archivist/issues/142].
