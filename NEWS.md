...
* Alterations in the text of: Tags.R file, Repository.R file, md5hash.R file, archivist-package.R file, `saveToRepo` function, `loadFromRepo` function, `summaryRepo` function, `showRepo` function, `searchInRepo` function, `createEmptyRepo` function.
