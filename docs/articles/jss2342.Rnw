%\documentclass[article]{jss} %for JSS style
\documentclass[nojss]{jss} %for package vignette (removes JSS style)
\bibliographystyle{unsrt}
%\usepackage{polski}
\usepackage[utf8]{inputenc}
\usepackage{color}

%\bibliography{name} % name of database with citations
%\usepackage{cite}
%\usepackage{listings}
%\usepackage{natbib} % load automatically with jss style
...
\begin{Sinput}
R> library("archivist")
R> models <- asearch("pbiecek/graphGallery", patterns = "class:lm")
R> modelsBIC <- sapply(models, BIC)
R> sort(modelsBIC)
\end{Sinput}
...
\begin{Sinput}
R> repo <- "arepo"
R> createLocalRepo(repoDir = repo, default = TRUE)
\end{Sinput}
...
\begin{Sinput}
R> repo <- "arepo"
R> deleteLocalRepo(repoDir = repo)
\end{Sinput}
...
\begin{Sinput}
R> showLocalRepo(repoDir = repo, method = "tags")
\end{Sinput}
\begin{Soutput}
                        artifact                      tag         createdDate
1 7f3453331910e3f321ef97d87adb5b               format:rda 2016-02-09 14:37:06
2 7f3453331910e3f321ef97d87adb5b                 class:gg 2016-02-09 14:37:06
3 7f3453331910e3f321ef97d87adb5b             class:ggplot 2016-02-09 14:37:06
4 7f3453331910e3f321ef97d87adb5b      labelx:Sepal.Length 2016-02-09 14:37:06
5 7f3453331910e3f321ef97d87adb5b      labely:Petal.Length 2016-02-09 14:37:06
6 7f3453331910e3f321ef97d87adb5b date:2016-02-09 14:37:06 2016-02-09 14:37:06
7 7f3453331910e3f321ef97d87adb5b               format:png 2016-02-09 14:37:06
8 ff575c261c949d073b2895b05d1097 relationWith:2166d...... 2015-06-22 17:17:14
8 ff575c261c949d073b2895b05d1097 sessionInfo:3b8c60...... 2015-06-22 17:17:14
\end{Soutput}
...
\begin{Sinput}
R> setRemoteRepo(user = "pbiecek", repo = "graphGallery", repoType = "github")
R> setLocalRepo(repoDir = 
+    system.file("graphGallery", package = "archivist"))
\end{Sinput}
...
R> library("ggplot2")
R> repo <- "arepo"
R> pl <- qplot(Sepal.Length, Petal.Length, data = iris)
R> saveToLocalRepo(pl, repoDir = repo)
\end{Sinput}
\begin{Soutput}
[1] "11127cc6ce69a89d11d0e30865a33c13"
attr(,"data")
...
\begin{Sinput}
R> showLocalRepo(repoDir = repo, "tags")
\end{Sinput}
\begin{Soutput}
                         artifact                     tag         createdDate
1  11127cc6ce69a89d11d0e30865a33c              format:rda 2016-02-09 16:42:59
2  11127cc6ce69a89d11d0e30865a33c                 name:pl 2016-02-09 16:42:59
3  11127cc6ce69a89d11d0e30865a33c                class:gg 2016-02-09 16:42:59
4  11127cc6ce69a89d11d0e30865a33c            class:ggplot 2016-02-09 16:42:59
5  11127cc6ce69a89d11d0e30865a33c     labelx:Sepal.Length 2016-02-09 16:42:59
6  11127cc6ce69a89d11d0e30865a33c     labely:Petal.Length 2016-02-09 16:42:59
7  11127cc6ce69a89d11d0e30865a33c  date:20160209 16:42:59 2016-02-09 16:42:59
8  11127cc6ce69a89d11d0e30865a33c session_info:e0373..... 2016-02-09 16:42:59
9  11127cc6ce69a89d11d0e30865a33c              format:png 2016-02-09 16:42:59
10 e037375a5f757efcc28561c0a1a2ef              format:rda 2016-02-09 16:42:59
11 ff575c261c949d073b2895b05d1097              format:rda 2016-02-09 16:42:59
12 ff575c261c949d073b2895b05d1097 session_info:e0373..... 2016-02-09 16:42:59
13 ff575c261c949d073b2895b05d1097              format:txt 2016-02-09 16:42:59
14 ff575c261c949d073b2895b05d1097 relationWith:11127..... 2016-02-09 16:42:59
\end{Soutput}
%\begin{Sinput}
%R> deleteRepo(repo)
%\%end{Sinput}
...
\begin{Sinput}
R> asession("11127cc6ce69a89d11d0e30865a33c13")
\end{Sinput}
\begin{Soutput}
Session info ------------------------------------------------------
 setting  value                       
...
Packages ----------------------------------------------------------
 ...
 archivist    * 1.9.7.3  2016-02-09 CRAN (R 3.2.2)                 
...
\begin{Sinput}
R> library("archivist")
R> createLocalRepo("arepo", default = TRUE)
R> library("dplyr")
R> iris %a%
+    dpyr::filter(Sepal.Length < 6) %a%
...
\begin{Sinput}
R> ahistory(tmp)
R> ahistory(md5hash = "050e41ec3bc40b3004bc6bdd356acae7")
\end{Sinput}
\begin{Soutput}
...
\begin{Sinput}
R> loadFromRemoteRepo("7f3453331910e3f321ef97d87adb5bad",
+    repo = "graphGallery", user = "pbiecek", value = TRUE)
R> loadFromLocalRepo("7f34533", 
...
\begin{Sinput}
R> archivist::aread("pbiecek/graphGallery/7f3453331910e3f321ef97d87adb5bad")
\end{Sinput}
...
\begin{Sinput}
R> library("archivist")
R> setLocalRepo(system.file("graphGallery", package = "archivist"))
R> aread("7f3453331910e3f321ef97d87adb5bad")
\end{Sinput}
...
\begin{Sinput}
R> setLocalRepo(system.file("graphGallery", package = "archivist"))
R> model <- aread("2a6e492cb6982f230e48cf46023e2e4f")
R> digest::digest(model)
\end{Sinput}
\begin{Soutput}
...
\begin{Sinput}
R> obj2rm <- searchInLocalRepo(list(dateFrom = "2010-01-01", 
+    dateTo = Sys.Date()-30), repoDir = repo)
R> rmFromLocalRepo(obj2rm, repoDir = repo, many = TRUE)
\end{Sinput}
...
\begin{Sinput}
R> searchInLocalRepo(pattern = "class:gg", 
...
\begin{Sinput}
R> searchInLocalRepo(pattern = list(dateFrom = "2016-01-01",
+    dateTo = "2016-02-07"), 
+    repoDir = system.file("graphGallery", package = "archivist"))
\end{Sinput}
\begin{Soutput}
...
\begin{Sinput}
R> searchInLocalRepo(pattern=c("class:gg", "labelx:Sepal.Length"),
+    repoDir = system.file("graphGallery", package = "archivist"))
\end{Sinput}
\begin{Soutput}
...
\begin{Sinput}
R> setLocalRepo(system.file("graphGallery", package = "archivist"))
R> models <- asearch(patterns = c("class:lm", "coefname:Sepal.Length"))
\end{Sinput}

Below is the code that searches within the GitHub repository.

\begin{Sinput}
R> models <- asearch("pbiecek/graphGallery",  
+    patterns = c("class:lm", "coefname:Sepal.Length"))
R> lapply(models, coef)
\end{Sinput}
\begin{Soutput}
$`18a98048f0584469483afb65294ce3ed`
...
\begin{Sinput}
R> plots <- asearch(patterns = c("class:gg", "labelx:Sepal.Length"))
R> length(plots)
\end{Sinput}
\begin{Soutput}
[1] 2
...
\begin{Sinput}
R> arepo <- system.file("graphGallery", package = "archivist")
R> shinySearchInLocalRepo(arepo)
\end{Sinput}
...
\begin{Sinput}
R> library("archivist")
R> createLocalRepo("allModels", default = TRUE)
R> atrace("lm", "z")
...
\begin{Sinput}
R> addHooksToPrint(class=c("ggplot", "data.frame"),
+                  repoDir = "arepo", 
...
\begin{Sinput}
R> createMDGallery("arepo/readme.md", 
+           repo = "Eseje", user = "pbiecek", subdir = "arepo", 
...
\begin{Sinput}
R> asession("pbiecek/graphGallery/arepo/600bda83cb840947976bd1ce3a11879d")
\end{Sinput}
\begin{Soutput}
...
...
\begin{Sinput}
R> aread("pbiecek/graphGallery/arepo/600bda83cb840947976bd1ce3a11879d")
\end{Sinput}
