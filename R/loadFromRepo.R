...
#' 
#' @details
#' Functions \code{loadFromLocalRepo} and \code{loadFromGithubRepo} load objects from the archivist Repositories stored in a local folder or on Github. Both of them take \code{md5hash} as a
