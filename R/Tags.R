...
#' 
#' \code{Tags} are stored in the \link{Repository}. If data is extracted from object a special \code{Tag}
#' named \code{relatedWith} is created, and specifies with which object this data is related to.
#' 
