...
Searching in Shiny repository

```{r}
library("archivist")
plots <- asearch("class:gg", "http://mi2.mini.pw.edu.pl:8080/archivist/arepo")
library("gridExtra")
do.call(grid.arrange, head(plots, 4))
```

Searching for models in local directory
